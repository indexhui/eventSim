...
import { StageResult, PlayerStatus } from "../../../types/game";
...
export function StageEvaluationScreen({
  stageResult,
  onContinue,
}: StageEvaluationScreenProps) {
        ...
        <VStack gap={8} align="stretch">
              ...
              <HStack gap={8} justify="space-around">
                ...
                <VStack>
                  ...
                  <Text
                    ...
                    fontWeight="bold"
                    color={
                      averageStats.心情 && averageStats.心情 > 0
                        ? "green.500"
                        : "red.500"
                    }
                  >
                ...
                <VStack>
                  ...
                  <Text
                    ...
                    fontWeight="bold"
                    color={
                      averageStats.體力 && averageStats.體力 > 0
                        ? "green.500"
                        : "red.500"
                    }
                  >
                ...
                <VStack>
                  ...
                  <Text
                    ...
                    fontWeight="bold"
                    color={
                      averageStats.儲蓄 && averageStats.儲蓄 > 0
                        ? "green.500"
                        : "red.500"
                    }
                  >
          ...
          <Box bg="white" p={6} borderRadius="lg" shadow="md">
            <VStack gap={4} align="stretch">
              ...
              <VStack gap={3} align="stretch">
                {generateRecommendations(averageStats).map(
